  ...
  return (
    <AnimatedContainer className="main-content">
      <div className="content">
        ...
        <p>Now this website is still in development, but in the meantime you can checkout my <a href="https://www.github.com/jamilettel">Github</a> (my projects there are pretty dated by now though).</p>
        <br />
